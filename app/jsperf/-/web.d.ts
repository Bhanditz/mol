...
declare namespace $ {
    ...
    class $mol_range2_array<Item> extends Array<Item> {
        ...
        map<Item_out, Context>(proceed: (this: Context, val?: Item, index?: number, list?: Item[]) => Item_out, context?: Context): any[];
        ...
        every<Context>(check: (this: Context, val?: Item, index?: number, list?: Item[]) => boolean, context?: Context): boolean;
    }
}
declare namespace $ {
