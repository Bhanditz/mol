    ...
    (function ($$) {
        $_1.$mol_test({
            'task add'($) {
                ...
                app.Add().event_done();
                $_1.$mol_assert_equal(app.task_ids().toString(), '1');
            ...
            'navigation'($) {
                ...
                app.Add().event_done();
                app.Task_row(1).Complete().event_click();
                $_1.$mol_assert_equal(app.task_ids_filtered().toString(), '1,2');
                app.$.$mol_state_arg.href(app.Filter_completed().uri());
                $_1.$mol_assert_equal(app.task_ids_filtered().toString(), '1');
                app.$.$mol_state_arg.href(app.Filter_active().uri());
                $_1.$mol_assert_equal(app.task_ids_filtered().toString(), '2');
