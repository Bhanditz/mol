...
(function ($) {
    class $mol_app_slides extends $.$mol_view {
        ...
        plugins() {
            return [].concat(this.Nav(), this.Speech_next(), this.Speech_slide(), this.Speech_prev(), this.Speech_start(), this.Speech_end(), this.Speech_about());
        }
        Nav() {
            return ((obj) => {
        ...
        Speaker() {
            return ((obj) => {
                obj.title = () => "";
                obj.tools = () => [].concat(this.Open_listener(), this.Speech_toggle());
        ...
        open_listener_hint() {
            return this.$.$mol_locale.text("$mol_app_slides_open_listener_hint");
        }
        Open_listener_icon() {
            return ((obj) => {
                return obj;
        ...
        speech_toggle_hint() {
            return this.$.$mol_locale.text("$mol_app_slides_speech_toggle_hint");
        }
        Speaker_content() {
            return ((obj) => {
                obj.uri_base = () => this.uri_base();
    ...
    __decorate([
        $.$mol_mem
    ], $mol_app_slides.prototype, "Nav", null);
    __decorate([
        $.$mol_mem
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $.$mol_mem_key
        ], $mol_app_slides.prototype, "page_tokens", null);
        __decorate([
            $.$mol_mem_key
        ], $mol_app_slides.prototype, "page_title", null);
        __decorate([
            $.$mol_mem
        ], $mol_app_slides.prototype, "title", null);
        __decorate([
            $.$mol_mem
        ], $mol_app_slides.prototype, "speaker_content", null);
        __decorate([
        ...
        __decorate([
            $.$mol_mem
        ], $mol_app_slides.prototype, "slide_keys", null);
        __decorate([
            $.$mol_mem
